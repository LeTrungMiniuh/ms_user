...
/**
 * Service Interface for managing {@link com.ticketsystem.user.domain.UserPreferences}.
 */
public interface UserPreferencesService {
    ...
    /**
     * Get all the UserPreferencesDTO where AppUser is {@code null}.
     *
     * @return the {@link List} of entities.
     */
    List<UserPreferencesDTO> findAllWhereAppUserIsNull();
